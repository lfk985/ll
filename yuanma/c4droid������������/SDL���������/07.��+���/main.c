/*c4下，g++编译通过。如果没有通过，请在c4设置中，g++参数 -lm前添加-std=c++11 (注，前后有空格)
*/
...
clip[5] =
{
SCREEN_WIDTH / 3, SCREEN_HEIGHT / 3, SCREEN_WIDTH / 3,
SCREEN_HEIGHT / 3};
clip[6] =
{
2 *SCREEN_WIDTH / 3, SCREEN_HEIGHT / 3, SCREEN_WIDTH / 3,
SCREEN_HEIGHT / 3};
clip[7] =
{
...
clip[8] =
{
SCREEN_WIDTH / 3, 2 * SCREEN_HEIGHT / 3, SCREEN_WIDTH / 3,
SCREEN_HEIGHT / 3};
// 各小图的具体位置
clip[0] =
{
...
break;
case 3:
apply_surface(2 * SCREEN_WIDTH / 3, 0, s, screen,
 &clip[map[0][2]]);
break;
case 4:
...
break;
case 5:
apply_surface(SCREEN_WIDTH / 3, SCREEN_HEIGHT / 3, s, screen,
 &clip[map[1][1]]);
break;
case 6:
apply_surface(2 * SCREEN_WIDTH / 3, SCREEN_HEIGHT / 3, s, screen,
 &clip[map[1][2]]);
break;
case 7:
apply_surface(0, 2 * SCREEN_HEIGHT / 3, s, screen,
 &clip[map[2][0]]);
break;
case 8:
apply_surface(SCREEN_WIDTH / 3, 2 * SCREEN_HEIGHT / 3, s, screen,
 &clip[map[2][1]]);
break;
default: ;
}//安小图数组顺序来粘贴小图
...
{
case SDLK_UP:if (b+1!=3) //把这个判断去掉会有大bug
{
