...
void CalcQiShuo(int year,int k)
{
	...
	else if (k==1)
	{
		for (int i=0;i<24;i++)
		{
			...
			printf ("%04g-%02g-%02g %02g:%02d:%02.0f\n",dat.Y,dat.M,dat.D,dat.h,(int)dat.m,dat.s);
		}
	}
	else if (k==0)
	{
		...
		for (int i=0;i<14;i++)
		{
			...
			printf ("%02d: %04g-%02g-%02g %02g:%02d:%02.0f\n",i+1,dat.Y,dat.M,dat.D,dat.h,(int)dat.m,dat.s);
		}
	}
}
