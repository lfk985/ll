...
void drawmap()
{
	...
	for (int j=0;j<=W;j++)
	{
		switch(map[i][j])
		{
			case 0:
			printf("\033[40;3%dm. "
			       "\33[40;37m",(snake.len+1)%8);//如果地图异常，请添加一个空格
			break;
			case 1:
			printf("\033[46;35m**\33[40;37m");
			break;
			case 2:
			printf("\033[4%d;33m%s"
			       "\33[40;37m",(snake.len+1)%7+1,head[n]);
			break;
			case 3:
			printf("\033[4%d;33m%s"
			       "\33[40;37m",snake.len%7+1,body[m]);
			break;
			case 4:
			printf("\033[4%d;33m%s"
			       "\33[40;37m",(snake.len+1)%7+1,body[m]);
			break;
		}
	}
	printf("\n");
